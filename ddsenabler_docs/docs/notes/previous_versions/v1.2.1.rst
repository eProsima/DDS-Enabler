...
* Append action infix to action topics
* Fix macOS/Clang debug warnings

This release includes the following **improvements**:

* Apply uncrustify to the whole repository
* Change default log verbosity to ``Error`` and add a discovery example
